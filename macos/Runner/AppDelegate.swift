...
class AppDelegate: FlutterAppDelegate {
    ...
    override func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        let channel = FlutterMethodChannel.init(name: "com.elysia/intent", binaryMessenger: controller.engine.binaryMessenger)
        self.menuChannel = FlutterMethodChannel.init(name: "com.elysia/appmenu",binaryMessenger: controller.engine.binaryMessenger)
        ...
        let storageChannel = FlutterMethodChannel.init(name: "com.elysia/storage", binaryMessenger: controller.engine.binaryMessenger)
